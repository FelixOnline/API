...
?>
    <?php
        ...
        $queries = array('articles' => "Articles",
            ...
            'comments-comment' => "Specific Comment",
            'comments-article' => "Comments by Article",
            'comments-reply' => "Replies for Comment",
            'sections' => "Sections",
            'sections-section' => "Specific Section",
            'frontpage' => "Frontpage Articles",
            'frontpage-section' => "Specific Frontpage Section Articles",
            'archive-publication' => "Archive Publication",
            'archive-publication-issues' => "Archive Issues in Publication",
            'archive-publication-issue' => "Archive Issue by Number in Publication",
            'archive-years' => "Archive Years",
            'archive-publication-years' => "Archive Years for Publication",
            'archive-year-issues' => "Archive Issues in Year",
            'archive-publication-year-issues' => "Archive Issues in Year for Publication",
            'archive-latest' => "Archive Latest Issues",
            'archive-issue' => "Archive Issue by ID",
            'user' => "Users",
