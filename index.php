<?php
    ...
    $urls = array(
        ...
        '/comments/(?P<id>[0-9]+)' => 'FelixOnline\API\commentController',
        '/comments/article/(?P<article>[0-9]+)' => 'FelixOnline\API\commentController',
        '/comments/replies/(?P<replies>[0-9]+)' => 'FelixOnline\API\commentController',
